...
```
Error: UndefVarError: tuples not defined
```
...
```
Error: ArgumentError: Package SciMLTutorials not found in current path:
- Run `import Pkg; Pkg.add("SciMLTutorials")` to install the SciMLTutorials
 package.
```
